...
export class UIController {
    ...
    private setupKeyboard(): void {
        document.addEventListener("keydown", (e) => {
            ...
            // Tab / Shift+Tab / 繧・ IntlRo ) : cycle active model
    ...
    private isLikelyCameraVmdPath(filePath: string): boolean {
        ...
        const fileName = normalized.substring(normalized.lastIndexOf("/") + 1);
        return fileName.includes("camera") || fileName.includes("cam") || fileName.includes("繧ｫ繝｡繝ｩ");
    }
    ...
    private updateAccessoryValueLabelsFromSliders(): void {
        ...
        setText("rx", `${rx.toFixed(1)}ﾂｰ`);
        setText("ry", `${ry.toFixed(1)}ﾂｰ`);
        setText("rz", `${rz.toFixed(1)}ﾂｰ`);
    ...
    private renderShaderCameraPostEffectsPanel(): void {
        ...
        this.shaderMaterialList.innerHTML = `
            <div class="shader-postfx-controls">
                ...
                <div class="effect-row">
                    <span class="effect-label" data-i18n="label.bloomStrength">Bloom強度</span>
